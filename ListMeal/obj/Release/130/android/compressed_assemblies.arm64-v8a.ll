...
@__CompressedAssemblyDescriptor_data_1 = internal global [130560 x i8] zeroinitializer, align 1
@__CompressedAssemblyDescriptor_data_2 = internal global [1126912 x i8] zeroinitializer, align 1
...
@__CompressedAssemblyDescriptor_data_21 = internal global [18072 x i8] zeroinitializer, align 1
@__CompressedAssemblyDescriptor_data_22 = internal global [1870848 x i8] zeroinitializer, align 1


; Compressed assembly data storage
@compressed_assembly_descriptors = internal global [23 x %struct.CompressedAssemblyDescriptor] [
	; 0
	...
	; 1
	%struct.CompressedAssemblyDescriptor {
		i32 130560, ; uncompressed_file_size
		i8 0, ; loaded
		i8* getelementptr inbounds ([130560 x i8], [130560 x i8]* @__CompressedAssemblyDescriptor_data_1, i32 0, i32 0); data
	}, 
	; 2
	%struct.CompressedAssemblyDescriptor {
		i32 1126912, ; uncompressed_file_size
		i8 0, ; loaded
		i8* getelementptr inbounds ([1126912 x i8], [1126912 x i8]* @__CompressedAssemblyDescriptor_data_2, i32 0, i32 0); data
	}, 
	; 3
	%struct.CompressedAssemblyDescriptor {
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i8 0, ; loaded
		i8* getelementptr inbounds ([18072 x i8], [18072 x i8]* @__CompressedAssemblyDescriptor_data_21, i32 0, i32 0); data
	}, 
	; 22
	%struct.CompressedAssemblyDescriptor {
		i32 1870848, ; uncompressed_file_size
		i8 0, ; loaded
		i8* getelementptr inbounds ([1870848 x i8], [1870848 x i8]* @__CompressedAssemblyDescriptor_data_22, i32 0, i32 0); data
	}
...
@compressed_assemblies = local_unnamed_addr global %struct.CompressedAssemblies {
	i32 23, ; count
	%struct.CompressedAssemblyDescriptor* getelementptr inbounds ([23 x %struct.CompressedAssemblyDescriptor], [23 x %struct.CompressedAssemblyDescriptor]* @compressed_assembly_descriptors, i32 0, i32 0); descriptors
}, align 8
